...
require (
	...
	github.com/drone-runners/drone-runner-aws v1.0.0-rc.179.1
	github.com/drone/go-task v0.0.0-20250213215142-3f3e2dce10ee
...
require (
	...
	github.com/hashicorp/nomad/api v0.0.0-20230421025320-b4e6a70fe69b // indirect
